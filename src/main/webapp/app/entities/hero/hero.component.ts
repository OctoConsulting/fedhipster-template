...
import { JhiEventManager, JhiParseLinks, JhiAlertService } from 'ng-fedhipster';
...
export class HeroComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    if (this.currentSearch) {
      this.heroService
        ...
        .subscribe(
          (res: HttpResponse<IHero[]>) => this.paginateHeroes(res.body, res.headers),
  ...
  protected paginateHeroes(data: IHero[], headers: HttpHeaders) {
